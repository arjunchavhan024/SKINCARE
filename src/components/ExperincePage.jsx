...
const ExperiencePage = () => {
  return (
    <section className="bg-[#FEFFF4] px-6 md:px-16 py-12">
      <div className="max-w-3xl mx-auto text-lg leading-relaxed text-gray-900">
        <p className="font-medium">
          ...
          <span className="text-gray-400 font-normal">
            ...
            day. Experience the ultimate in skincare with our expertly
            formulated products, crafted to nourish, protect, and rejuvenate
            your skin.
          </span>
        </p>
      </div>
